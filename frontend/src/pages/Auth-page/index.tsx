...
import GoogleAuthLogin from './auth-components/Google-Auth';
...
const ProdXAuth = () => {
    ...
    const handleGoogleLogin = async (credentialsResponse: any) => {
        const token = credentialsResponse.credentials;
        try {
            const response = await apiClient.post("http://localhost:5000/api/v1/auth/google-auth", {
                token
            })
                    ...
                    >
                        <Card className="w-full max-w-md rounded-3xl border-0 shadow-2xl bg-white/80 backdrop-blur-xl">
                            ...
                            <CardContent className="space-y-6">
                                ...
                                <GoogleAuthLogin handleGoogleLogin={handleGoogleLogin} />
