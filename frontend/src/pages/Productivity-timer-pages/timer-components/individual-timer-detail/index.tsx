...
const IndividualTimerDetail = ({
    timer,
    onBack,
}: IndividualTimerDetailProps) => {

    const [isRunning, setIsRunning] =
        useState(timer.isActive);

    const completedTime =
        timer.completedTime ?? 0;
    ...
    return (
        ...
        >
            ...
            <div
                ...
                style={{
                    background:
                        "linear-gradient(145deg, #1e1b4b 0%, #312e81 45%, #4c1d95 100%)",

                    boxShadow:
                        "0 24px 72px rgba(79,46,220,0.42)",
                }}
            >
                ...
                <div
                    ...
                    style={{
                        background:
                            "radial-gradient(circle, rgba(192,132,252,0.14), transparent)",
                    }}
                />
